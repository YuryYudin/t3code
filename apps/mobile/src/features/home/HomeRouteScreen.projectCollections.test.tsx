...
vi.mock("../layout/AdaptiveWorkspaceLayout", () => ({
  useAdaptiveWorkspaceLayout: () => ({ layout: { usesSplitView: runtime.usesSplitView } }),
}));
vi.mock("../layout/WorkspaceEmptyDetail", () => ({
  WorkspaceEmptyDetail: "workspace-empty-detail",
}));
vi.mock("../layout/workspace-sidebar-toolbar", async () => {
  ...
  return {
    ...
    }) => React.createElement("workspace-sidebar-toolbar", null, afterSidebarButton),
  };
});
